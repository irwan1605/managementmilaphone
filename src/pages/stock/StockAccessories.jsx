...
export default function StockAccessories() {
  ...
  function exportExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "ACC_TOKO");
    const ymd = today().replace(/-/g, "");
    const safe = tokoName.replace(/[^\p{L}\p{N}_-]+/gu, "_");
    XLSX.writeFile(wb, `STOCK_ACC_${safe}_${ymd}.xlsx`);
  }
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 w-full max-w-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-2 mt-6">
                ...
                />
                <label htmlFor="syncSystemAcc" className="text-sm">
