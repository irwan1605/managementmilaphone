...
const HapusPenjualan = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 h-screen">
      <h1 className="text-2xl font-bold mb-6">Hapus Data Penjualan</h1>
      {/* Form Edit Data Penjualan */}
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 shadow-md rounded">
        <div>
        <h1 className="text-2xl font-bold mb-4">Form Hapus Penjualan</h1>
        ...
        <button type="submit" className="bg-red-500 text-white px-4 py-2 rounded hover:bg-green-600">
          Hapus Penjualan
        </button>
        <button
        onClick={() => navigate(-1)}
