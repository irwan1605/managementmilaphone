...
const StockHandphone = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">Stock Handphone</h1>

      {/* Form Input Penjualan Baru */}
      <div className="bg-white p-4 rounded shadow-lg mb-6">
        <h2 className="text-xl font-semibold mb-4">Tambah Stock Handphone</h2>
        ...
        >
          Tambah Stock Handphone
        </button>
      </div>

      {/* Tabel Daftar Penjualan */}
      <div className="bg-white p-4 rounded shadow-lg">
        <h2 className="text-xl font-semibold mb-4">Daftar Stock Handphone</h2>
